...
def get_encoder(model_name, model_path):
    with open(os.path.join(model_path, model_name, 'vocab.json'), 'r') as f:
        encoder = json.load(f)
    with open(os.path.join(model_path, model_name, 'merges.txt'), 'r', encoding="utf-8") as f:
        bpe_data = f.read()
